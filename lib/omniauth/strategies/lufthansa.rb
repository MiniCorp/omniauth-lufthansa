  ...
  module Strategies
    class Lufthansa < OmniAuth::Strategies::OAuth2
      ...
      def self.code_verifier
        @code_verifier ||= begin
          code_verifier_length = MIN_LENGTH + (rand(0..MAX_LENGTH) % (MAX_LENGTH - MIN_LENGTH))
          code_verifier = ''
      ...
      option :client_options, {
        site: "https://oauth-test.lufthansa.com",
        authorize_url: "https://oauth-test.lufthansa.com/oauth/authorize",
        token_url: "https://oauth-test.lufthansa.com/oauth/token"
      }
